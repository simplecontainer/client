...
func Restart() contracts.Command {
	return command.Command{
		...
		Functions: []func(*manager.Manager, []string){
			func(mgr *manager.Manager, args []string) {
				...
				event := events.New(events.EVENT_RESTART, static.KIND_CONTAINER, static.SMR_PREFIX, static.KIND_CONTAINER, format.GetGroup(), format.GetName(), nil)
